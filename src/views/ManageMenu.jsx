  ...
  return (
    <>
      <div>
        ...
        <h1 className="mb-4 px-2 text-center text-xl font-semibold text-yellow-500 md:text-3xl">
        ...
        {selectedItem ? (
          ...
          <div className="flex w-full justify-center px-2 md:w-auto md:p-8">
            <table className="min-w-full table-auto border border-[#2a2c2b] md:min-w-4/5 md:p-8">
              <thead>
                <tr>
